        ...
        <footer className="py-5">
          ...
          <div className="d-flex justify-content-between py-4 my-4 border-top">
            ...
            <ul className="list-unstyled d-flex">
              <li className="ms-3"><a className="link-dark"><svg className="bi" width={24} height={24}><use xlinkHref="#twitter" /></svg></a></li>
              <li className="ms-3"><a className="link-dark"><svg className="bi" width={24} height={24}><use xlinkHref="#instagram" /></svg></a></li>
              <li className="ms-3"><a className="link-dark"><svg className="bi" width={24} height={24}><use xlinkHref="#facebook" /></svg></a></li>
            </ul>
          </div>
        </footer>
      </div>
